...
![image](https://c65mael.github.io/myassets-beg/chongdingxiang.png)
...
- 导入表注入的实现步骤：
  ...
  2. ```c
     ...
     ![image](https://c65mael.github.io/myassets-beg/daorubiaozhuru.png)
...
- 完整的一个消息流程
  ...
  ![image](https://c65mael.github.io/myassets-beg/xiaoxi1.png)
...
![image](https://c65mael.github.io/myassets-beg/ziyuan.png)
...
- 临界区的设计思路：
  ...
  ![image](https://c65mael.github.io/myassets-beg/lingjiequ.png)
...
- 什么是内核对象？
  ...
  ![image](https://c65mael.github.io/myassets-beg/nhdx0.png)
...
- `CreateProcess`的做了什么：
  ...
  1. 创建内核对象
     ...
     ![image](https://c65mael.github.io/myassets-beg/neiheduixiang.png)
...
- 汇编语言格式：
  ...
  ![image](https://c65mael.github.io/myassets-beg/ybm1.png)
...
- 当指令中出现内存操作对象的时候，就需要在操作码后面附加一个字节来进行补充说明，这个字节被称为`ModR/M`。
  ...
  ![image](https://c65mael.github.io/myassets-beg/ybm2.png)

- 实例：

  ![image](https://c65mael.github.io/myassets-beg/ybm2-1.png)

  ![image](https://c65mael.github.io/myassets-beg/ybm2-2.png)

  ![image](https://c65mael.github.io/myassets-beg/ybm2-3.png)

  当`Mod = 11`时，`ModR/M`字节直接操作两个寄存器：

  ![image](https://c65mael.github.io/myassets-beg/ybm2-4.png)
...
- `ModR/M`字段是用来进行内存寻址的，可当地址形如`DS:[EAX + ECX*2 + 12345678]`时，仅仅靠`ModR/M`字段，是描述不出来的。这时就在`ModR/M`后面增加一个`SIB`字节，与`ModR/M`字段共同描述。
  ...
  ![image](https://c65mael.github.io/myassets-beg/ybm3.png)

- 实例：

  ![image](https://c65mael.github.io/myassets-beg/ybm3-1.png)
  
  ![image](https://c65mael.github.io/myassets-beg/ybm3-2.png)
  
  ![image](https://c65mael.github.io/myassets-beg/ybm3-3.png)
...
- 实例：
  ...
  ![image](https://c65mael.github.io/myassets-beg/ybm4.png)
