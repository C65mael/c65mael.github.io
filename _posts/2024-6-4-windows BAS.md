...
底层逻辑就是连续存储，与相同数量的一维数组等效。区别仅仅是开发人员好找数组中的值，编译器找值是套公式的，假如在数组`arr[5][4][3]`中找`arr[1][2][1]`​，则是arr[1×4×3+2×3+1]
...
1. 不局限与父类的继承：
   ...
   ![image](https://c65mael.github.io/myassets-bas/image-20231230133511-95nzlym.png)
...
2. 多重继承：
   ...
   ![image](https://c65mael.github.io/myassets-bas/image-20231230134009-b93hjmf.png)
